...
binding.pry
	  ...
	  sales_phenol = 	SalesOutbound.where(date: sales_start..sales_end,product:Product.where(name:['Phenol','Hydrated Phenol'])).sum(:metric_tons).round(2)
		...
		production_phenol =  Production.where(date: aday-1.day,parameters: 'prd',product:Product.where(name:'Phenol')).sum(:value).round(2)
		...
		inbound_coal_tt = Inbound.where(date: aday-1.day,product:Product.where(name:'Coal'),logistic_location:LogisticLocation.where(name:'unloading')).sum(:total_tons).round(2)
		inbound_cumene_tt = Inbound.where(date: aday-1.day,product:Product.where(name:'Cumene'),logistic_location:LogisticLocation.where(name:'unloading')).sum(:total_tons).round(2)
		inbound_benzene_tt = Inbound.where(date: aday-1.day,product:Product.where(name:'Benzene'),logistic_location:LogisticLocation.where(name:'unloading')).sum(:total_tons).round(2)
		inbound_propylene_tt = Inbound.where(date: aday-1.day,product:Product.where(name:'Propylene'),logistic_location:LogisticLocation.where(name:'unloading')).sum(:total_tons).round(2)
